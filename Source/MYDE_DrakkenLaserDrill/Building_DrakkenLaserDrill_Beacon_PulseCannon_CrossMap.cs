...
public class Building_DrakkenLaserDrill_Beacon_PulseCannon_CrossMap : ThingWithComps
{
    ...
    public void CheckSpawn(Building_DrakkenLaserDrill buildingDrakkenLaserDrill, Vector2 realPos, float gunAngle,
    ...
    protected override void DrawAt(Vector3 drawLoc, bool flip = false)
    {
        ...
        if (Building_DrakkenLaserDrill.DamageNum >= 6)
        {
            ...
            var vector3_By_AngleFlat =
                MYDE_ModFront.GetVector3_By_AngleFlat(building_DrakkenLaserDrill_VPos, 5.5f, num);
    ...
    public override void Destroy(DestroyMode mode = DestroyMode.Vanish)
    {
        ...
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_PulseCannon_CrossMap>().EffectTick = 0;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_PulseCannon_CrossMap>().LaserScaleTick = 0;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_PulseCannon_CrossMap>().MinLaserChangeTick = 0;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_PulseCannon_CrossMap>().MinLaserPos_A_Range = 0.5f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_PulseCannon_CrossMap>().MinLaserPos_A_UpOrDown =
            true;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_PulseCannon_CrossMap>().MinLaserPos_B_Range =
            -0.5f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_PulseCannon_CrossMap>().MinLaserPos_B_UpOrDown =
            false;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_PulseCannon_CrossMap>().MinLaserPos_C_Range = 0.2f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_PulseCannon_CrossMap>().MinLaserPos_C_UpOrDown =
            true;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_PulseCannon_CrossMap>().MinLaserPos_D_Range =
            -0.2f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_PulseCannon_CrossMap>().MinLaserPos_D_UpOrDown =
            false;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_PulseCannon_CrossMap>().MinLaserPos_E_Range =
            -0.1f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_PulseCannon_CrossMap>().MinLaserPos_E_UpOrDown =
            true;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_PulseCannon_CrossMap>().MinLaserPos_F_Range = 0.1f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_PulseCannon_CrossMap>().MinLaserPos_F_UpOrDown =
            false;
        base.Destroy(mode);
    }
