...
namespace MYDE_DrakkenLaserDrill
{
    ...
    public class Comp_DrakkenLaserDrill_ConcentratedBeam_CrossMap : ThingComp
    {
        ...
        private static readonly Texture2D Icon_CrossMap = ContentFinder<Texture2D>.Get("DrakkenLaserDrill_Icon/ConcentratedBeam_CrossMap");
        private static readonly Texture2D Tex_LaserBig = ContentFinder<Texture2D>.Get("DrakkenLaserDrill_Laser/Laser_Big_ConcentratedBeam");
        ...
        public override IEnumerable<Gizmo> CompGetGizmosExtra()
        {
            ...
            var ResearchProject = DefDatabase<ResearchProjectDef>.GetNamed("MYDE_DrakkenLaserDrill_Research_ConcentratedBeam", false);

            var Building_DrakkenLaserDrill = parent as Building_DrakkenLaserDrill;
            if (Building_DrakkenLaserDrill != null &&
                (!Building_DrakkenLaserDrill.IfCrossMap || (ResearchProject != null && !ResearchProject.IsFinished)))
            {
                yield break;
            }
            ...
            {
                // 충전 중
                float current = Building_DrakkenLaserDrill?.ConcentratedBeam_EnergyAccumulation ?? 0f;
                float max = Building_DrakkenLaserDrill?.ConcentratedBeam_EnergyAccumulationMax ?? 1f;
