...
public class Building_DrakkenLaserDrill_Beacon_CrossMap : ThingWithComps
{
    ...
    private Vector3 Building_DrakkenLaserDrill_VPos;
    ...
    public void CheckSpawn(Building_DrakkenLaserDrill buildingDrakkenLaserDrill, Vector2 realPos,
        List<Thing> listThing, Thing targetThing, float gunAngle, Vector3 buildingDrakkenLaserDrillVPos,
        float trueMapRange)
    {
        ...
        GunAngle = gunAngle;
        Building_DrakkenLaserDrill_VPos = buildingDrakkenLaserDrillVPos;
        True_Map_Range = trueMapRange;
    }
    ...
    public override void ExposeData()
    {
        ...
        DeepProfiler.End();
        Scribe_Values.Look(ref Building_DrakkenLaserDrill_VPos, "Building_DrakkenLaserDrill_VPos");
    ...
    protected override void DrawAt(Vector3 drawLoc, bool flip = false)
    {
        ...
        {
            var building_DrakkenLaserDrill_VPos = Building_DrakkenLaserDrill_VPos;
            var vector = new Vector3(RealPos.x, DrawPos.y, RealPos.y);
            var pos = (building_DrakkenLaserDrill_VPos + vector) / 2f;
            pos.y = AltitudeLayer.PawnRope.AltitudeFor(3f);
            var lengthHorizontal = (building_DrakkenLaserDrill_VPos.ToIntVec3() - vector.ToIntVec3()).LengthHorizontal;
            var x = 1.2f;
            ...
            var angle = (building_DrakkenLaserDrill_VPos - vector).AngleFlat();
            var a = 0.8f;
    ...
    protected override void Tick()
    {
        ...
        Building_DrakkenLaserDrill.GunAngle = GunAngle;
    }
    ...
    public void FindNextTarget(Thing OldTarget)
    {
        ...
        if (ListThing.Count > 0)
        {
            ...
            for (var i = 0; i < ListThing.Count; i++)
            {
                ...
                else if (ListThing[i] is Building)
                {
                    if (!ListThing[i].Destroyed)
                    {
                        list2.Add(ListThing[i]);
                    }
                    else if (ListThing[i].Destroyed)
                    {
                        ListThing.Remove(ListThing[i]);
                    }
                }
            }
            ...
            if (list.Count > 0)
            {
                foreach (var targetThing in list)
                {
                    if (targetThing == null || !((Position - targetThing.Position).LengthHorizontal < num))
                    {
                        continue;
                    }

                    TargetThing = targetThing;
                    num = (Position - targetThing.Position).LengthHorizontal;
                }
            }
            else
            {
                ...
                foreach (var targetThing in list2)
                {
                    if (!((Position - targetThing.Position).LengthHorizontal < num))
                    {
                        continue;
                    }
    ...
    public override void Destroy(DestroyMode mode = DestroyMode.Vanish)
    {
        ...
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_Attack_CrossMap>().MinLaserPos_A_Range = 0.5f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_Attack_CrossMap>().MinLaserPos_A_UpOrDown = true;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_Attack_CrossMap>().MinLaserPos_B_Range = -0.5f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_Attack_CrossMap>().MinLaserPos_B_UpOrDown = false;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_Attack_CrossMap>().MinLaserPos_C_Range = 0.2f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_Attack_CrossMap>().MinLaserPos_C_UpOrDown = true;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_Attack_CrossMap>().MinLaserPos_D_Range = -0.2f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_Attack_CrossMap>().MinLaserPos_D_UpOrDown = false;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_Attack_CrossMap>().MinLaserPos_E_Range = -0.1f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_Attack_CrossMap>().MinLaserPos_E_UpOrDown = true;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_Attack_CrossMap>().MinLaserPos_F_Range = 0.1f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_Attack_CrossMap>().MinLaserPos_F_UpOrDown = false;
        base.Destroy(mode);
    }
    ...
    private void Get_MinLaserPos_A_Pos()
    {
        ...
        var building_DrakkenLaserDrill_VPos = Building_DrakkenLaserDrill_VPos;
        var vector = new Vector3(RealPos.x, DrawPos.y, RealPos.y);
        var num = (building_DrakkenLaserDrill_VPos - vector).AngleFlat();
        var num2 = num - 90f;
        if (num2 < 0f)
        {
            num2 = 360f + num2;
        ...
        MinLaserPos_A_Start =
            MYDE_ModFront.GetVector3_By_AngleFlat(building_DrakkenLaserDrill_VPos, minLaserPos_A_Range, num2);
    ...
    private void Get_MinLaserPos_B_Pos()
    {
        ...
        MinLaserPos_B_Start =
            MYDE_ModFront.GetVector3_By_AngleFlat(building_DrakkenLaserDrill_VPos, minLaserPos_B_Range, num2);
    ...
    private void Get_MinLaserPos_C_Pos()
    {
        ...
        MinLaserPos_C_Start =
            MYDE_ModFront.GetVector3_By_AngleFlat(building_DrakkenLaserDrill_VPos, minLaserPos_C_Range, num2);
    ...
    private void Get_MinLaserPos_D_Pos()
    {
        ...
        MinLaserPos_D_Start =
            MYDE_ModFront.GetVector3_By_AngleFlat(building_DrakkenLaserDrill_VPos, minLaserPos_D_Range, num2);
    ...
    private void Get_MinLaserPos_E_Pos()
    {
        ...
        MinLaserPos_E_Start =
            MYDE_ModFront.GetVector3_By_AngleFlat(building_DrakkenLaserDrill_VPos, minLaserPos_E_Range, num2);
    ...
    private void Get_MinLaserPos_F_Pos()
    {
        ...
        MinLaserPos_F_Start =
            MYDE_ModFront.GetVector3_By_AngleFlat(building_DrakkenLaserDrill_VPos, minLaserPos_F_Range, num2);
