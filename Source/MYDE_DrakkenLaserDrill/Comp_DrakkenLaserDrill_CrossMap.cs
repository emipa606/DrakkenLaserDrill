...
public class Comp_DrakkenLaserDrill_CrossMap : ThingComp
{
    ...
    private static readonly Texture2D
        Icon_False = ContentFinder<Texture2D>.Get("DrakkenLaserDrill_Icon/CrossMap_False");

    public CompProperties_DrakkenLaserDrill_CrossMap Props => props as CompProperties_DrakkenLaserDrill_CrossMap;

    public override IEnumerable<Gizmo> CompGetGizmosExtra()
    {
        if (parent is not Building_DrakkenLaserDrill building)
        {
            yield break;
        }
    ...
    private void DoSomething_CrossMapSwitch()
    {
        ...
        building_DrakkenLaserDrill.IfCrossMap = !building_DrakkenLaserDrill.IfCrossMap;
    }
