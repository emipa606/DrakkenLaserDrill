...
namespace MYDE_DrakkenLaserDrill
{
    ...
    {
        // [수정] 텍스처 캐싱 (성능 최적화) - 아이콘 및 레이저 텍스처
        private static readonly Texture2D Icon_CrossMap = ContentFinder<Texture2D>.Get("DrakkenLaserDrill_Icon/Beacon_CrossMap");
        private static readonly Texture2D Icon_AllAttack = ContentFinder<Texture2D>.Get("DrakkenLaserDrill_Icon/AllAttack _CrossMap");
        ...
        // 기존 인스턴스 텍스처 변수 삭제됨 (static으로 대체)
        ...
        public override IEnumerable<Gizmo> CompGetGizmosExtra()
        {
            ...
            yield return new Command_Action
            {
                ...
                icon = Icon_AllAttack, // [수정] 캐시된 아이콘
            ...
            Find.Targeter.BeginTargeting(targetingParameters, delegate (LocalTargetInfo Target)
            {
...

                {
                    ...
                    ((Building_DrakkenLaserDrill_Beacon_CrossMap)GenSpawn.Spawn(building_DrakkenLaserDrill_Beacon_CrossMap,
                                            ...
                                            vector3_By_AngleFlat, num9, num9);
            ...
            if (list2.Count > 0)
            {
                ...
                if (thing != null)
                {
                    ...
                    ((Building_DrakkenLaserDrill_Beacon_CrossMap)GenSpawn.Spawn(building_DrakkenLaserDrill_Beacon_CrossMap,
                                            ...
                                            vector3_By_AngleFlat, num4, num4);
                }
        ...
        public override void PostDraw()
        {
            ...
            if (building_DrakkenLaserDrill.DamageNum >= 6)
            {
                ...
                // [수정] 텍스처 로딩 대신 캐시된 변수 사용 (매 프레임 성능 향상)
        ...
        // [이하 생략된 메서드들: Get_MinLaserPos_A_Pos ~ Get_MinLaserPos_F_Pos]
        // 이 부분들은 코드가 길어서 변경 사항이 없는 부분은 그대로 사용하세요.
        // *중요*: 로직은 건드리지 않았습니다.
        ...
        {
            // [수정] 텍스처 로딩 코드 삭제 (성능 저하의 주범)
            // Building_DrakkenLaserDrill_Icon_CrossMap = ContentFinder<Texture2D>.Get("..."); 
