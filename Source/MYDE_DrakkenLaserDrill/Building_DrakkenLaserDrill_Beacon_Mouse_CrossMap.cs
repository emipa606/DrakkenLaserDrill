...
public class Building_DrakkenLaserDrill_Beacon_Mouse_CrossMap : ThingWithComps
{
    ...
    public void CheckSpawn(Building_DrakkenLaserDrill buildingDrakkenLaserDrill, Vector2 realPos, Vector3 targetPos,
        float gunAngle, Vector3 buildingDrakkenLaserDrillVPos, float trueMapRange)
    {
    ...
    protected override void Tick()
    {
        ...
        {
            TakeDamageTick = 0;
            Building_DrakkenLaserDrill.DamagePos_CrossMap();
        }
    ...
    {
        Building_DrakkenLaserDrill.Building_DrakkenLaserDrill_Beacon_Mouse_CrossMap = null;
        Building_DrakkenLaserDrill.ChangePowerConsumeToZero();
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_MouseAttack_CrossMap>().MinLaserPos_A_Range = 0.5f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_MouseAttack_CrossMap>().MinLaserPos_A_UpOrDown =
            true;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_MouseAttack_CrossMap>().MinLaserPos_B_Range =
            -0.5f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_MouseAttack_CrossMap>().MinLaserPos_B_UpOrDown =
            false;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_MouseAttack_CrossMap>().MinLaserPos_C_Range = 0.2f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_MouseAttack_CrossMap>().MinLaserPos_C_UpOrDown =
            true;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_MouseAttack_CrossMap>().MinLaserPos_D_Range =
            -0.2f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_MouseAttack_CrossMap>().MinLaserPos_D_UpOrDown =
            false;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_MouseAttack_CrossMap>().MinLaserPos_E_Range =
            -0.1f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_MouseAttack_CrossMap>().MinLaserPos_E_UpOrDown =
            true;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_MouseAttack_CrossMap>().MinLaserPos_F_Range = 0.1f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_MouseAttack_CrossMap>().MinLaserPos_F_UpOrDown =
            false;
        base.Destroy(mode);
    }
