...
namespace MYDE_DrakkenLaserDrill
{
    ...
    {
        // [수정] 텍스처 캐싱 (성능 최적화)
        private static readonly Texture2D Icon_MouseAttack_CrossMap = ContentFinder<Texture2D>.Get("DrakkenLaserDrill_Icon/MouseAttack_CrossMap");
        ...
        private void DoSomething_I()
        {
            ...
            var Map = parent.Map;
            var MaxRange = 66;
            Find.WorldTargeter.BeginTargeting((System.Func<GlobalTargetInfo, bool>)ChoseWorldTarget, true, null, true,
