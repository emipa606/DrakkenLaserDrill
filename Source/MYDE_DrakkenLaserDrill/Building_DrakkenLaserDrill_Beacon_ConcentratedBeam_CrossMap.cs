...
public class Building_DrakkenLaserDrill_Beacon_ConcentratedBeam_CrossMap : ThingWithComps
{
    ...
    public void CheckSpawn(Building_DrakkenLaserDrill buildingDrakkenLaserDrill, Vector2 realPos,
        List<IntVec3> listAllPos, List<IntVec3> listAllPosEffect, float gunAngle,
        Vector3 buildingDrakkenLaserDrillVPos, float trueMapRange)
    {
    ...
    protected override void DrawAt(Vector3 drawLoc, bool flip = false)
    {
        ...
        if (Building_DrakkenLaserDrill.DamageNum >= 6)
        {
            ...
            var num5 = (building_DrakkenLaserDrill_VPos - vector).AngleFlat();
            var a = 0.8f;
            ...
            var vector3_By_AngleFlat =
                MYDE_ModFront.GetVector3_By_AngleFlat(building_DrakkenLaserDrill_VPos, 5.5f, num5);
    ...
    public override void Destroy(DestroyMode mode = DestroyMode.Vanish)
    {
        ...
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_ConcentratedBeam_CrossMap>().EffectTick = 0;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_ConcentratedBeam_CrossMap>().LaserScaleTick = 0;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_ConcentratedBeam_CrossMap>().MinLaserChangeTick =
            0;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_ConcentratedBeam_CrossMap>().MinLaserPos_A_Range =
            0.5f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_ConcentratedBeam_CrossMap>()
            .MinLaserPos_A_UpOrDown = true;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_ConcentratedBeam_CrossMap>().MinLaserPos_B_Range =
            -0.5f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_ConcentratedBeam_CrossMap>()
            .MinLaserPos_B_UpOrDown = false;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_ConcentratedBeam_CrossMap>().MinLaserPos_C_Range =
            0.2f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_ConcentratedBeam_CrossMap>()
            .MinLaserPos_C_UpOrDown = true;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_ConcentratedBeam_CrossMap>().MinLaserPos_D_Range =
            -0.2f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_ConcentratedBeam_CrossMap>()
            .MinLaserPos_D_UpOrDown = false;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_ConcentratedBeam_CrossMap>().MinLaserPos_E_Range =
            -0.1f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_ConcentratedBeam_CrossMap>()
            .MinLaserPos_E_UpOrDown = true;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_ConcentratedBeam_CrossMap>().MinLaserPos_F_Range =
            0.1f;
        Building_DrakkenLaserDrill.TryGetComp<Comp_DrakkenLaserDrill_ConcentratedBeam_CrossMap>()
    ...
    {
        var num = (DrawPos - Building_DrakkenLaserDrill_VPos).AngleFlat();
        var num2 = 1 + (DestroyTick / 5);
        ...
        {
            var num3 = Rand.Range(-0.5f, 0.5f);
            var vector = ListAllPos_Effect.RandomElement().ToVector3Shifted();
            var loc = vector + new Vector3(num3, 0f, num3);
            var scale = Rand.Range(1f, 1.5f);
            var dataStatic = FleckMaker.GetDataStatic(loc, Map,
                MYDE_FleckDefOf.MYDE_Building_DrakkenLaserDrill_Fleck_ConcentratedBeam_Spark, scale);
            dataStatic.rotation = num + 90f;
            dataStatic.velocityAngle = num;
            dataStatic.velocitySpeed = Rand.Range(40f, 60f);
            dataStatic.instanceColor = new Color(r, g, b);
            dataStatic.def.solidTime = 0.6f;
            if (DestroyTick >= 120)
            {
                dataStatic.def.solidTime = 0.6f - ((DestroyTick - 120f) / 100f);
            }
        ...
        for (var j = 0; j <= num2; j++)
        {
            ...
            var loc2 = vector2 + new Vector3(num4, 0f, num4);
            var scale2 = Rand.Range(1f, 1.5f);
            var dataStatic2 = FleckMaker.GetDataStatic(loc2, Map,
                MYDE_FleckDefOf.MYDE_Building_DrakkenLaserDrill_Fleck_ConcentratedBeam_Spark, scale2);
            dataStatic2.rotation = num + 90f;
            dataStatic2.velocityAngle = num;
            dataStatic2.velocitySpeed = Rand.Range(40f, 60f);
            dataStatic2.instanceColor = new Color(r2, g2, b2);
            dataStatic2.def.solidTime = 0.6f;
            if (DestroyTick >= 120)
            {
                dataStatic2.def.solidTime = 0.6f - ((DestroyTick - 120f) / 100f);
            }
    ...
    private void Get_MinLaserPos_A_Pos()
    {
        ...
        var vector3_By_AngleFlat = MYDE_ModFront.GetVector3_By_AngleFlat(building_DrakkenLaserDrill_VPos, 6f, num);
