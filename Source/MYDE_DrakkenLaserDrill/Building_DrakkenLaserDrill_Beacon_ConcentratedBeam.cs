...
namespace MYDE_DrakkenLaserDrill
{
    ...
    public class Building_DrakkenLaserDrill_Beacon_ConcentratedBeam : ThingWithComps
    {
        ...
        private List<IntVec3> ListAllPos_Effect = new List<IntVec3>();
        ...
        protected override void DrawAt(Vector3 drawLoc, bool flip = false)
        {
            ...
            if (Building_DrakkenLaserDrill == null || Building_DrakkenLaserDrill.Now_Rebuilding)
            {
                return;
            }
        ...
        private void TakeDamage()
        {
            ...
            for (var j = 0; j < list.Count; j++)
            {
                ...
                else
                {
                    ...
                    if (list[j] is Mineable mineable)
                    {
        ...
        // Get_MinLaserPos_A_Pos ~ F_Pos는 로직 변경 없으므로 그대로 두면 됩니다 (지면상 생략, 위 코드에 포함됨)
