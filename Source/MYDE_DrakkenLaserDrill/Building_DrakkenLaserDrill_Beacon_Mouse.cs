...
namespace MYDE_DrakkenLaserDrill
{
    ...
    public class Building_DrakkenLaserDrill_Beacon_Mouse : ThingWithComps
    {
        ...
        // Mouse Beacon은 TargetThing 대신 TargetPos(좌표)를 사용합니다.
        ...
        protected override void Tick()
        {
            base.Tick();
            var map = Map;
            var drawPos = TargetPos; // Mouse 비콘은 좌표가 타겟
            var vector = new Vector3(RealPos.x, DrawPos.y, RealPos.y);
            ...
            if (TakeDamageTick >= TakeDamageTickMax && LaserScaleTick >= 30)
            {
                ...
                if (TakeDamageBool)
                {
                    // Mouse Attack은 특정 타겟(TargetThing)이 아니라 해당 위치(Pos)에 데미지를 줍니다.
        ...
        // [이하 Get_MinLaserPos 및 Draw_MinLaserPos 메서드는 최적화 적용됨]

        private void Get_MinLaserPos_A_Pos()
        {
            if (MinLaserPos_A_UpOrDown) { MinLaserPos_A_Range -= 0.01f; if (MinLaserPos_A_Range <= -MinLaserPos_A_Range_Limit) MinLaserPos_A_UpOrDown = false; }
            else { MinLaserPos_A_Range += 0.01f; if (MinLaserPos_A_Range >= MinLaserPos_A_Range_Limit) MinLaserPos_A_UpOrDown = true; }
            var minLaserPos_A_Range = MinLaserPos_A_Range; var drawPos = Building_DrakkenLaserDrill.DrawPos; var vector = new Vector3(RealPos.x, DrawPos.y, RealPos.y); var num = (drawPos - vector).AngleFlat(); var num2 = num - 90f; if (num2 < 0f) num2 += 360f;
        ...
        private void Get_MinLaserPos_B_Pos()
        {
            ...
            var minLaserPos_B_Range = MinLaserPos_B_Range; var drawPos = Building_DrakkenLaserDrill.DrawPos; var vector = new Vector3(RealPos.x, DrawPos.y, RealPos.y); var num = (drawPos - vector).AngleFlat(); var num2 = num - 90f; if (num2 < 0f) num2 += 360f;
        ...
        private void Get_MinLaserPos_C_Pos()
        {
            ...
            var minLaserPos_C_Range = MinLaserPos_C_Range; var drawPos = Building_DrakkenLaserDrill.DrawPos; var vector = new Vector3(RealPos.x, DrawPos.y, RealPos.y); var num = (drawPos - vector).AngleFlat(); var num2 = num - 90f; if (num2 < 0f) num2 += 360f;
        ...
        private void Get_MinLaserPos_D_Pos()
        {
            ...
            var minLaserPos_D_Range = MinLaserPos_D_Range; var drawPos = Building_DrakkenLaserDrill.DrawPos; var vector = new Vector3(RealPos.x, DrawPos.y, RealPos.y); var num = (drawPos - vector).AngleFlat(); var num2 = num - 90f; if (num2 < 0f) num2 += 360f;
        ...
        private void Get_MinLaserPos_E_Pos()
        {
            ...
            var minLaserPos_E_Range = MinLaserPos_E_Range; var drawPos = Building_DrakkenLaserDrill.DrawPos; var vector = new Vector3(RealPos.x, DrawPos.y, RealPos.y); var num = (drawPos - vector).AngleFlat(); var num2 = num - 90f; if (num2 < 0f) num2 += 360f;
        ...
        private void Get_MinLaserPos_F_Pos()
        {
            ...
            var minLaserPos_F_Range = MinLaserPos_F_Range; var drawPos = Building_DrakkenLaserDrill.DrawPos; var vector = new Vector3(RealPos.x, DrawPos.y, RealPos.y); var num = (drawPos - vector).AngleFlat(); var num2 = num - 90f; if (num2 < 0f) num2 += 360f;
