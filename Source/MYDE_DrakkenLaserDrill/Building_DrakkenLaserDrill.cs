...
namespace MYDE_DrakkenLaserDrill
{
    ...
    public class Building_DrakkenLaserDrill : Building
    {
        ...
        protected override void DrawAt(Vector3 drawLoc, bool flip = false)
        {
            ...
            // [수정] TryGetComp 삭제하고 cached 변수 사용
        ...
        public void DamageTarget()
        {
            if (!Now_Rebuilding)
            {
                ...
                if (cachedPowerTrader != null)
                {
                    ...
                    else if (!cachedPowerTrader.PowerOn)
                    {
                        DestroyAllBeacon();
                    }
                }
        ...
        private void Add_PulseCannon_EnergyAccumulation()
        {
            ...
            if (cachedPowerTrader == null || !(cachedPowerTrader.PowerOutput < 0f) || IfImmunity)
            {
                return;
            }
